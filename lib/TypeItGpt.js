...
class TypeItGpt {
    ...
    setStyles() {
        var _a, _b, _c, _d;
        (_a = this.options.messageContainer) === null || _a === void 0 ? void 0 : _a.style.setProperty('--blink-interval', `${this.options.timings.blinkInterval}ms`);
        (_b = this.options.messageContainer) === null || _b === void 0 ? void 0 : _b.style.setProperty('--cursor-width', this.options.cursorWidth);
        (_c = this.options.messageContainer) === null || _c === void 0 ? void 0 : _c.style.setProperty('--cursor-color', this.options.cursorColor);
        (_d = this.options.messageContainer) === null || _d === void 0 ? void 0 : _d.style.setProperty('--text-color', this.options.textColor);
