...
class TypeItGpt {
    ...
    setStyles() {
        ...
        (_d = this.options.messageContainer) === null || _d === void 0 ? void 0 : _d.style.setProperty('--type-it-gpt-text-color', this.options.textColor);
        if (this.options.backgroundColor !== '') {
            (_e = this.options.messageContainer) === null || _e === void 0 ? void 0 : _e.style.setProperty('--type-it-gpt-background-color', this.options.backgroundColor);
        }
